...
if (isset($_COOKIE['sid'])) {
   ...
   $sql ="SELECT cookie_id FROM cookie WHERE cookie_wert ='$L_cookie'";
...
//Bonsai ////////////////////////////////////////////////////////////////////////////// GEÄNDERT!!!
    ...
    echo "<div class=\"landing_mosaik_1\">";
        ...
        echo "<button name=\"L_LPshopFilter\" value=\"Bäumchen\" class=\"button1\" type=\"submit\"> Jetzt kaufen </button>";
    echo "</div>";
 ...
 //Blume /////////////////////////////////////////////////////////////////////////////////  GEÄNDERT!!!
      echo "<div class=\"landing_mosaik_2\">";
            ...
            echo "<button name=\"L_LPshopFilter\" value=\"Blume\" class=\"button1\"> Jetzt kaufen </button>";
      echo "</div>";
 ...
 //Kaktus//////////////////////////////////////////////////////////////////////////////////   GEÄNDERT!!!
     echo "<div class=\"landing_mosaik_3\">";
        ...
        echo "<button name=\"L_LPshopFilter\" value=\"kaktus\" class=\"button1\"> Jetzt kaufen </button>";
     echo "</div>";
    
    
    
 //Grünpflanze////////////////////////////////////////////////////////////////////////////////   GEÄNDERT!!!
     echo "<div class=\"landing_mosaik_4\">";

        echo "<span class=\"landing_mosaik_weiß\"> Gr&uuml;npflanze </span> <br>";

        echo "<button name=\"L_LPshopFilter\" value=\"grün\" class=\"button1\"> Jetzt kaufen </button>";
     echo "</div>";
 ...
 //Schenken////////////////////////////////////////////////////////////////////////////////   GEÄNDERT!!!
    echo "<div class=\"landing_mosaik_5\">";
        ...
        echo "<button name=\"L_LPshopFilter\" value=\"leicht\" class=\"button1\"> Jetzt kaufen </button>";
    echo "</div>";
...
include "Antonia/Landing_controller_Lbearb.php"; //---!!!!!!!!!!!!!!!!!!!!!!!!!!!!---ÄNDERN?---//
